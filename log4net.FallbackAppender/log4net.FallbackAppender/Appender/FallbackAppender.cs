...
namespace log4net.FallbackAppender.Appender
{
    #region enums
    ...
    /// <appender name="FallbackAppender" type="log4net.FallbackAppender.Appender.FallbackAppender, log4net.FallbackAppender" >
